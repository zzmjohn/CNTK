...
#pragma pop_macro("DeclareTernaryTensorOp")
    ...
    void DoMatrixProductOf(ElemType beta, bool transC, const TensorView& a, bool transA, const TensorView& b, bool transB, ElemType alpha, shared_ptr<QuantizerBase<ElemType, short>> pQuantizer = nullptr);
    void AssignMatrixProductOf(bool transC, const TensorView& a, bool transA, const TensorView& b, bool transB, ElemType alpha = 1.0f, shared_ptr<QuantizerBase<ElemType, short>> pQuantizer = nullptr) { DoMatrixProductOf(0, transC, a, transA, b, transB, alpha, pQuantizer); }
