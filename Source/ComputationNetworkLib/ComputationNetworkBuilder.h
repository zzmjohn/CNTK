...
public:
    ...
    ComputationNodePtr QuantizedTimes(const ComputationNodePtr a, const ComputationNodePtr b, size_t extraBits = 1, size_t outputRank = 1, const std::wstring nodeName = L"");
#if 1 // legacy
