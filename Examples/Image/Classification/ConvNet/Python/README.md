...
Note that [this example](https://github.com/Microsoft/CNTK/blob/v2.0.beta4.0/Examples/Image/Classification/ConvNet/Python/ConvNet_CIFAR10_DataAug_Distributed.py) support CPU-only build.
